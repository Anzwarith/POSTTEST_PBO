...
class Padeline {
    ...
    static void lihatLapangan(){
        ...
        for(Lapangan l : listLapangan){
            if(l.getTersedia()){
                System.out.println("Lapangan "+l.getNomorLapangan()+" : Tersedia");
            }else{
                System.out.println("Lapangan "+l.getNomorLapangan()+" : Tidak tersedia");
            }
        }
    }
        ...
        for(Booking b : listBooking){
            System.out.println(
                    "Lapangan : "+b.getNomorLapangan()+
                            " | Jam Mulai : "+b.getJamMulai()+
                            " | Durasi : "+b.getDurasiJam()+
    ...
    static void bayarBooking(){
        ...
        for(Booking b : listBooking){
            if(b.getNomorLapangan().equals(nomor)){
                System.out.println("Total yang harus dibayar : "+b.getTotalHarga());
